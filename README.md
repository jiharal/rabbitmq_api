...
API Started
publish status {'correlation_id': '21e3dba5-eed8-4f8b-b7a6-052f336e2e3e', 'success': False, 'message': 'Server is down', 'data': None}
(venv) ➜  rabbitmq_api python start_server.py none
API Started
...
Received message: '{"correlation_id": "21e3dba5-eed8-4f8b-b7a6-052f336e2e3e", "success": false, "message": "Server is down", "data": null}'
